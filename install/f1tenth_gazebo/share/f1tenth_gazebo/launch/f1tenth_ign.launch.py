    ...
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=[
                ...
                '/model/car1_red/odometry_gt@nav_msgs/msg/Odometry[ignition.msgs.Odometry',
            ...
            remappings=[
                ...
                ('/model/car1_red/odometry_gt', '/red/odometry_gt'),
                ('/red_scan', '/red/scan'),
        ...
        # Static TF: map -> odom (offset by red car spawn position)
        Node(
            package='tf2_ros',
